...
public class DeleteContactsPresenter extends BasePresenter<DeleteContactsView> {

    private Context mContext;

    public DeleteContactsPresenter(Context context){
            ...
            public void subscribe(ObservableEmitter<List<MallListModel>> e) throws Exception {
                ...
                .subscribe(new Observer<List<MallListModel>>() {
                    ...
                    public void onNext(List<MallListModel> value) {
                        mView.get().getContactsList(value);
                        onComplete();
                    }
    ...
    public void filterData(List<MallListModel> sourceDateList , String filterStr , PinyinComparator pinyinComparator, DeleteContactsAdapter sortAdapter) {
