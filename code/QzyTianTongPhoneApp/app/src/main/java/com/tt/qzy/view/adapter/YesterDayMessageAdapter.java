...
public class YesterDayMessageAdapter extends BaseQuickAdapter<ShortMessageModel,BaseViewHolder>{

    private List<ShortMessageModel> mModelList;

    public YesterDayMessageAdapter(List<ShortMessageModel> list){
