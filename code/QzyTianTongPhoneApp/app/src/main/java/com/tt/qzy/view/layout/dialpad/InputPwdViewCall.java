...
public class InputPwdViewCall extends LinearLayout implements View.OnTouchListener, View.OnClickListener,
    ...
    private int input_bg_color = DEFAULT_FILL_COLOR;
    private int input_btn_bg_color = DEFAULT_FILL_COLOR;
    private boolean input_hide;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.InputPwdView);
        input_bg_color = a.getColor(R.styleable.InputPwdView_input_bg_color, DEFAULT_FILL_COLOR);
        input_btn_bg_color = a.getColor(R.styleable.InputPwdView_input_btn_bg_color, DEFAULT_FILL_COLOR);
        input_hide = a.getBoolean(R.styleable.InputPwdView_input_hide, false);
        input_text_color = a.getColor(R.styleable.InputPwdView_input_text_color,DEFAULT_BORDER_COLOR);
    }
    ...
    public void init() {
      ...
      /*   one.setBackgroundColor(input_btn_bg_color);
        ...
        five.setBackgroundColor(input_btn_bg_color);
        six.setBackgroundColor(input_btn_bg_color);
        seven.setBackgroundColor(input_btn_bg_color);
        eight.setBackgroundColor(input_btn_bg_color);
        nine.setBackgroundColor(input_btn_bg_color);
        software.setBackgroundColor(input_btn_bg_color);
        tellphone.setBackgroundColor(input_btn_bg_color);
        clear.setBackgroundColor(input_btn_bg_color);
        start.setBackgroundColor(input_btn_bg_color);
        zero.setBackgroundColor(input_btn_bg_color);
        jinghao.setBackgroundColor(input_btn_bg_color);*/
    }
