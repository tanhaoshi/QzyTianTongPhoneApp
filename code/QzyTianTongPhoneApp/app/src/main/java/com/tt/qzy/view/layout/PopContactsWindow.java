...
public class PopContactsWindow extends PopWindow{
    ...
    private TextView editor_contacts;

    public PopContactsWindow(Context context){
    ...
    private void initView() {
        ...
        mMenuView = inflater.inflate(R.layout.pop_caotacts_layout,null);
        ...
        editor_contacts = (TextView)mMenuView.findViewById(R.id.contacts_editor);
    ...
    private void initListener(){
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NToast.shortToast(mContext,"删除该联系人所有的通话记录");
                dismiss();
            }
        });
        ...
        editor_contacts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
