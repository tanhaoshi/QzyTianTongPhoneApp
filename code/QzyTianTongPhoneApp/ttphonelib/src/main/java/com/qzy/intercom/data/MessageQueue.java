...
public class MessageQueue {
    ...
    @Retention(SOURCE)
    @IntDef({ENCODER_DATA_QUEUE, SENDER_DATA_QUEUE, DECODER_DATA_QUEUE, TRACKER_DATA_QUEUE,LSOCKET_DATA_QUEUE})
    ...
    public static final int LSOCKET_DATA_QUEUE = 4;
    ...
    public static void release(){
        ...
        MessageQueue.getInstance(MessageQueue.LSOCKET_DATA_QUEUE).clear();
    }
}
