...
public class AudioDataUtilDe {
    ...
    public static byte[] raw2spx(short[] audioData) {
        ...
        SpeexUtils.getDeSpeex().encode(audioData, encodedData, audioData.length);
        return encodedData;
    }
    ...
    public static short[] spx2raw(byte[] encodedData) {
        ...
        SpeexUtils.getDeSpeex().decode(encodedData, shortRawData, encodedFrameSize);
        return shortRawData;
    }
