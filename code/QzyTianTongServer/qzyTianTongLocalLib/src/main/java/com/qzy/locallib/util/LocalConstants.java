...
public class LocalConstants {
    ...
    // 单播端口号
    public static final int UNICAST_PORT = 8999;
    public static final int UNICAST_PORT_1 = 7999;
    // 采样频率
    public static final int sampleRateInHz = 8000;

    public static String UNICAST_BROADCAST_IP = "192.168.43.1";
